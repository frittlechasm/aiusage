...
assert_eq "Spark 5h" "$(codex_spark_window_label '5h')"        "codex_spark_window_label: prefixes a rolling window"
assert_eq "Spark Wk" "$(codex_spark_window_label 'Weekly')"    "codex_spark_window_label: compacts the weekly window"
